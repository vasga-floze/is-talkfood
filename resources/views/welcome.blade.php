    ...
    <body class="container-fluid">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="row ml-5 my-5">
                <div class="col-7 mx-1">
                    <div class="col-md-12">
                        ...
                        <div class="flex content-justify-center">
                            <img class="img-fluid shadow sm:rounded-lg" src="{{asset('images/banner.png')}}" alt="Responsive image">
                        </div>
                            ...
                            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img class="img-fluid" src="{{asset('images/hamb.png')}}" alt="Responsive image">
                                    </div>
                                    <div class="carousel-item">
                                        <img class="img-fluid" src="{{asset('images/comid.png')}}" alt="Responsive image">
                                    </div>
                                    <div class="carousel-item">
                                        <img class="img-fluid" src="{{asset('images/pla.png')}}" alt="Responsive image">
                                    </div>
                                </div>
                ...
                <div class="col-4 shadow p-3 mb-5 bg-white rounded mx-1">
                    <!--logo-->
